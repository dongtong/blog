...
},{"../tags/greet-form.tag":3,"../tags/hello-world.tag":4,"../tags/todo-list.tag":5,"../tags/word-counter.tag":6,"riot":1}],3:[function(require,module,exports){
...
var riot = require('riot');
module.exports = riot.tag2('todo-list', '<input type="text" id="newTodo" placeholder="请输入待办事项(回车添加)..." onkeyup="{add}"> <ul> <li each="{todos}"> <todo></todo> </li> <ul>', '', '', function(opts) {
...
riot.tag2('todo', '<p> {content} - <span class="{red: completed, green: !completed}">{completed ? \'完成\' : \'待办\'}</span> <button onclick="{this.parent.complete}" if="{!completed}">完成</button> </p>', '', '', function(opts) {
}, '{ }');
